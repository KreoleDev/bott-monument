      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative z-10">
            <p className="text-[10px] tracking-[0.5em] text-primary font-bold uppercase mb-6">
              Our Standard
            </p>
            ...
            <div className="relative">
              ...
              <Quote className="h-10 w-10 text-primary/20 mb-6" strokeWidth={1} />
              ...
              <blockquote className="text-xl md:text-3xl text-foreground/90 font-serif italic leading-[1.4] mb-8 pr-4">
                ...
                We craft each piece with a <span className="text-foreground font-medium not-italic border-b-2 border-primary/30">magazine cover</span> in mind."
              </blockquote>
          ...
          <div className="relative group">
            ...
            <div className="relative aspect-[3/4] md:aspect-[4/5] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute bottom-8 left-8">
                <p className="text-[10px] uppercase tracking-[0.2em] text-white/80 font-light border-l border-primary pl-4">
